...
import { getInitMintInfo, getPercent, addCommasToNumber } from "./utils.js"
import { mint, freeMint as freeMintWeb3 } from "../utils/web3.js";
...
function MintLayout({ isBaby }) {
    ...
    const normalMint = async (showModal) => {
    ...
    return <Layout>
        ...
        <MainBox>
            ...
            <BtmBox>
                ...
                <RhtBox>
                    <PhotoBox>
                        {isBaby ? <img src={BabyLImg} alt="Baby Loong Picture" /> : <img src={GreatLImg} alt="Great Loong Picture" />}
                    </PhotoBox>
